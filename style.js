const style = {
  ...
  metadata: {
    ...
    'mapbox:decompiler': {
      ...
      propConfig: {
        'road-network': {
          colorBase: 'hsl(220, 8%, 92%)',
          roadNetwork: 'Simple',
          roadWidth: 0.6,
          colorRoadLabel: 'hsl(220, 9%, 22%)',
          roadsFont: ['Roboto Regular', 'Arial Unicode MS Regular'],
          shieldsFont: ['Roboto Bold', 'Arial Unicode MS Bold'],
        },
        'natural-features': {
          colorBase: 'hsl(220, 8%, 92%)',
          labelStyle: 'Text only',
          density: 1,
          colorWater: 'hsl(198, 61%, 72%)',
          colorPoi: 'hsl(172, 48%, 51%)',
          poiEtcFont: ['Roboto Medium', 'Arial Unicode MS Regular'],
          waterLabelsFont: [
        ...
        'place-labels': {
          countriesFont: ['Roboto Medium', 'Arial Unicode MS Regular'],
          settlementLabelStyle: 'Text only',
          continentsFont: ['Roboto Medium', 'Arial Unicode MS Regular'],
          settlementsMajorSize: 1.1,
          colorPlaceLabel: 'hsl(220, 14%, 40%)',
          statesFont: ['Roboto Bold', 'Arial Unicode MS Bold'],
          colorBase: 'hsl(220, 8%, 92%)',
          settlementSubdivisionsDensity: 3,
          settlementsMinorFont: ['Roboto Regular', 'Arial Unicode MS Regular'],
          settlementsMajorFont: ['Roboto Medium', 'Arial Unicode MS Regular'],
        ...
        buildings: {
          colorBase: 'hsl(220, 8%, 92%)',
          houseNumbers: false,
          houseNumbersFont: ['Roboto Italic', 'Arial Unicode MS Regular'],
        },
      },
    },
    'mapbox:uiParadigm': 'components',
  },
  center: [2.7320915386351032, 42.96726993922579],
  zoom: 8.217379626310166,
  bearing: 0,
  pitch: 0,
  fog: {
    range: [-1, 10],
  ...
  sprite: 'mapbox://sprites/purplena/clivmpcoe001q01qq3qa63u67/draft',
  ...
  layers: [
    ...
    },
    {
      ...
      'source-layer': 'water',
      layout: {},
      paint: { 'fill-color': 'hsl(198, 61%, 72%)' },
    },
    {
    ...
    },
    {
      ...
      layout: {},
      paint: {
        'fill-color': 'hsl(220, 3%, 81%)',
        'fill-opacity': ['interpolate', ['linear'], ['zoom'], 15, 0, 16, 1],
        'fill-outline-color': 'hsl(220, 0%, 75%)',
      },
    },
    {
    ...
    },
    {
      ...
      paint: {
        'line-width': ['interpolate', ['linear'], ['zoom'], 3, 4.8, 12, 9.6],
        'line-color': 'hsl(220, 2%, 77%)',
        'line-opacity': ['interpolate', ['linear'], ['zoom'], 3, 0, 4, 0.5],
        'line-blur': ['interpolate', ['linear'], ['zoom'], 3, 0, 12, 2.4],
      },
    },
    {
      id: 'admin-2-boundary',
      ...
      paint: {
        ...
        'line-width': ['interpolate', ['linear'], ['zoom'], 3, 0.3, 12, 1],
        'line-opacity': ['interpolate', ['linear'], ['zoom'], 5, 0, 6, 1],
        'line-color': 'hsl(220, 6%, 61%)',
      },
    },
    {
      id: 'admin-1-boundary',
    ...
    },
    {
      ...
      layout: {},
      paint: {
        'line-color': 'hsl(220, 0%, 60%)',
        'line-width': ['interpolate', ['linear'], ['zoom'], 3, 0.6, 12, 2.4],
        'line-dasharray': [10, 0],
      },
    },
    {
    ...
    },
    {
      ...
      paint: {
        'text-color': 'hsl(220, 9%, 22%)',
        'text-halo-color': 'hsl(220, 4%, 95%)',
        'text-halo-width': 1,
      },
    },
    {
      ...
      layout: {
        'text-font': ['Roboto Condensed Italic', 'Arial Unicode MS Regular'],
        'text-max-angle': 30,
        'symbol-spacing': [
          'interpolate',
          ['linear', 1],
      ...
      paint: {
        'text-color': 'hsl(198, 29%, 57%)',
        'text-halo-color': 'hsla(220, 4%, 95%, 0.5)',
      },
    },
    {
    ...
    },
    {
      ...
      paint: {
        'text-halo-color': 'hsla(220, 13%, 100%, 0.75)',
        'text-halo-width': 1,
        'text-color': 'hsl(220, 14%, 47%)',
        'text-halo-blur': 0.5,
      },
    },
    {
      ...
      paint: {
        'text-color': 'hsl(220, 14%, 11%)',
        'text-halo-color': 'hsl(220, 13%, 100%)',
        'text-halo-width': 1,
  ...
  created: '2023-06-14T11:28:33.903Z',
  modified: '2023-06-14T12:43:43.473Z',
  id: 'clivmpcoe001q01qq3qa63u67',
  owner: 'purplena',
  visibility: 'private',
  protected: false,
